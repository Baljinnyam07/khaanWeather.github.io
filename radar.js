maptilersdk.config.apiKey = 'KFRONs89clwsK2jKgnHY';
      ...
      document.getElementById('showRadar').addEventListener('click', function () {
      showMap();
    });
    ...
    // Function to show the map and hide the forecast
    function showMap() {
      document.getElementById('map').style.display = 'block';
      document.getElementById('forecast').style.display = 'none';
    }

    // Function to show the forecast and hide the map
    ...
    window.onload = function () {
      showMap(); // Show the map by default
    };
